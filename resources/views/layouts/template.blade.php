...
<!--get tickets section -->
<section class=" pt100 pb100" style="background-image: url('assets/img/bg/pattern.jpeg'); background-size: cover">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-9 text-md-left text-center color-light">
                Daftarkan diri Anda segera, jadilah bagian dari kompetisi {{env('APP_NAME')}} dan raih juaranya!
            </div>
            <div class="col-md-3 text-md-right text-center">
            <a href="{{route('register')}}" class="btn btn-primary btn-rounded mt30">Daftar Sekarang</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="footer_box">
                    <div class="footer_header">
                        <div class="footer_logo">
                            <img src="/assets/img/comic-x.png" alt="COMIC 9 STIKOM BALI" style="width: 120px; height: 100px;">
                        </div>
                    </div>
                    <div class="footer_box_body">
                        <p>
                            COMIC adalah singkatan dari Competition of Islamic Creativity, merupakan ajang perlombaan yang diadakan oleh UKM MCOS STIKOM Bali untuk berkompetisi dalam berbagai bidang dalam Islam. COMIC diikuti oleh peserta dari berbagai jenjang seperti SD, SMP dan SMA atau Sederajat se-Bali, Jawa dan Lombok.
                        </p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by IT Support {{env('APP_NAME')}}
