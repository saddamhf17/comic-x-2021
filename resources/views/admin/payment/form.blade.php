...
@section('back_button')
<a href="{{route('admin.payment.index')}}" class="mb-2 d-block"><small><i class="fa fa-arrow-left"></i> Kembali</small></a>
@endsection
@section('content')
<div class="row">
    <div class="col-lg-4">
        <div class="card mb-3">
            ...
            <div class="card-body text-gray-800">
                ...
                @if($models->status == 0)
                <hr style="border-top-style: dotted;">
                <b class="mb-2">Ubah Status : </b> <br>

                <small></small>
                
                <a href="javascript:void(0)"  onclick="receive('{{route('admin.payment.receive', $models->uuid)}}')"  class="btn mb-1 btn-success btn-sm">Terima</a>
                <a href="javascript:void(0)"  onclick="decline('{{route('admin.payment.decline', $models->uuid)}}')"  class="btn mb-1 ml-1 btn-danger btn-sm">Tolak</a>
                @endif
            ...
            <div class="card-body text-gray-800">
                @foreach ($models->detail as $item)
                    <p>
                        ...
                        <br>
                    <small><a href="{{route('admin.competitor.edit', $item->competitor->uuid)}}">Lihat</a></small>
                    </p>
                    <hr>
                @endforeach
            </div>
...
<script>
    ...
    function receive(id) {
      swal({
        ...
        text: "Setelah diterima, data penerimaan pembayaran akan diteruskan ke peserta lomba",
        icon: "info",
        buttons: true,
        dangerMode: false,
      })
